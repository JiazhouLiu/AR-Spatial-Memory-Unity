...
/// </summary>
public class RawLogger : MonoBehaviour

{
    #region Constants to modify
    private const string SessionFolderRoot = "SpatialMemory";
    private const string Header = "TimeSinceStart,UserHeight,TrialNo,TrialID,ParticipantID,ExperimentSequence,Layout,Difficulty,TrialState," +
    ...
    public void StartNewCSV(string fileName)
    {
